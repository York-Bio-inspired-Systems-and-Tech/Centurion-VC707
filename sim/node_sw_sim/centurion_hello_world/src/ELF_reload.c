...
#define LOADER_RX_BUFF ((volatile unsigned int*)(0xC1000000 + (2*LOADER_TX_BUFF_SIZE)))
...
void Init_Barrier_Sync(Xuint8 sync_value) __attribute__ ((section (".reloader")));
...
void Init_Barrier_Sync(Xuint8 sync_value)
{
	while(1)
	{
